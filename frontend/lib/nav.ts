...
export const SECTIONS: Section[] = [
  ...
  { id: 'briefing', label: 'Morning Briefing', group: 'Automation', ready: true,
    blurb: 'What Jarvis tells you at the start of the day.' },
  { id: 'profile', label: 'Profile & Goals', group: 'About You', ready: true,
    blurb: 'What Jarvis knows about you, and what you are working towards.' },
  { id: 'memory', label: 'Memory', group: 'About You', ready: true,
    blurb: 'Every durable fact Jarvis has saved — editable and undoable.' },
  { id: 'improvement', label: 'Self-Improvement', group: 'About You', ready: true,
