...
import { createSkill } from '../skills/store/skill-files.js';
// NOT `import { reservedSkillNames } from './index.js'` or from
// '../capabilities.js' — this file is itself dynamically imported BY
// tools/index.js's loader loop at startup, so a top-level import back to
// either would deadlock it (see CLAUDE.md's circular-import invariant).
// capabilities.js's invoke() injects `ctx.reservedSkillNames` for exactly
// this reason — see capabilities.js's invoke() comment.
