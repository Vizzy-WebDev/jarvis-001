...
export default {
  ...
  meta: true,
  // Core tool — see get_time.js's comment on the same field. Orthogonal to
  // `meta` above: core controls the default live-chat declaration set,
  // meta controls background-run/skill-picker visibility.
  core: true,
  description:
