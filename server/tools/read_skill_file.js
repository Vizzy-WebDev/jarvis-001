...
import { resolveSkillPath, listSkillFiles, readSkillFile as readFile } from '../skills/store/skill-files.js';
...
export default {
  ...
  // Deliberately NOT meta:true. `meta` (see tools/index.js) is for abilities
  ...
  // picker (listCapabilities()) as a pickable action, taking a skill+path pair —
